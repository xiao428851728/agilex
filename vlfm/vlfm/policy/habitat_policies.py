...
HM3D_ID_TO_NAME = ["chair", "bed", "potted plant", "toilet", "tv", "couch", "fire hydrant", "bicycle", "umbrella", "backpack","Trash can","book"]
MP3D_ID_TO_NAME = [
    "chair",
...
class HabitatMixin:
    ...
    def __init__(
        ...
        **kwargs: Any,
        ...
        print("Camera FOV:", camera_fov_rad)
    ...
    def _cache_observations(self: Union["HabitatMixin", BaseObjectNavPolicy], observations: TensorDict) -> None:
        ...
        camera_position = np.array([x, y, 0.35]) #self._camera_height]) # TODO: 修改 camera_height，在 config 中改
