...
# # =================================================================
# # 🛠️ 修复开始：Mock spot_wrapper 防止报错
# # =================================================================
# try:
#     from spot_wrapper.spot import Spot, image_response_to_cv2
# except ImportError:
#     # 如果没安装 spot_wrapper，就定义假的类和函数来骗过解释器
#     print("⚠️ Warning: 'spot_wrapper' module not found. Using mocks for compatibility.")
    
#     class Spot:
#         def __init__(self, name=""): pass
#         def get_lease(self, *args, **kwargs): 
#             class Lease:
#                 def __enter__(self): pass
#                 def __exit__(self, *args): pass
#             return Lease()
#         def power_on(self): pass
#         def blocking_stand(self): pass
    
#     def image_response_to_cv2(*args, **kwargs):
